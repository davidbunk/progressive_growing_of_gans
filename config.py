...
data_dir = 'datasets'
result_dir = '/scratch/bunk/results/karras_progan'
...
desc        = 'EM'                                        # Description string included in result subdir name.
...
D_2_opt  = EasyDict(beta1=0.0, beta2=0.99, epsilon=1e-8) # Options for phase 2 discriminator optimizer.
G_loss     = EasyDict(func='loss.G_wgan_acgan')            # Options for phase 1 generator loss.
G_2_loss = EasyDict(func='loss.G_2_wgan_acgan')            # Options for phase 2 generator loss.
D_loss    = EasyDict(func='loss.D_wgangp_acgan')          # Options for discriminator loss.
D_2_loss = EasyDict(func='loss.D_2_wgangp_acgan')          # Options for discriminator loss.
...
#desc += '-preset-v2-1gpu'; num_gpus = 1; sched.minibatch_base = 1; sched.minibatch_dict = {4: 128, 8: 128, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8, 512: 4}; sched.G_lrate_dict = {1024: 0.0015}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 240
desc += '-preset-v2-2gpus'; num_gpus = 2; sched.minibatch_base = 8; sched.minibatch_dict = {4: 256, 8: 256, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8}; sched.G_lrate_dict = {512: 0.0015, 1024: 0.002}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 24000
